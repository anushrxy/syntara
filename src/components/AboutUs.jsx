...
function AboutUs() {
  const card1Descriptions = ['Authenticity', 'Uniqueness', 'Cherished Collectibles'];
  const card2Descriptions = ['Security', 'Community', 'Lasting Memories'];
  const card3Descriptions = ['Team of 3','Anushrey Jain', 'Raj Aryan', 'Anmol Pattnayak'];
  return (
    <div className="py-10 px-4 flex flex-col items-center justify-start bg-bg-tertiary">
      <div>
      ...
      <div className="flex flex-col lg:flex-row gap-[1px] mt-5 md:mt-10">
        <AboutCard img={"https://res.cloudinary.com/dh7z3wkfx/image/upload/v1693076406/Group_49_i0q2ap.png"} heading={"Our Vision"} descriptions={card1Descriptions}/>
        <AboutCard img={"https://res.cloudinary.com/dh7z3wkfx/image/upload/v1693076406/Group_50_svbyl1.png"} heading={"Our Mission"} descriptions={card2Descriptions}/>
        <AboutCard img={"https://res.cloudinary.com/dh7z3wkfx/image/upload/v1693076406/Group_52_b1fdpx.png"} heading={"Our Team"} descriptions={card3Descriptions}/>
      </div>
    </div>
  );
}
